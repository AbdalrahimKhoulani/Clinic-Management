...
public interface AppointmentRepository extends JpaRepository<Appointment,Integer> {
    ...
    List<Appointment> findByPatientId(@Param("patientId") int patient_id,@Param("isAppointmentActive") boolean isAppointmentActive ,@Param("isPatientActive") boolean isPatientActive);*/
   /* @Query("SELECT a FROM Appointment a JOIN a.doctor d " +
            "WHERE d.doctorId =:doctorId " +
            "AND a.isActive =:isAppointmentActive " +
            "AND d.isActive =:isDoctorActive")
    List<Appointment> findByDoctor(@Param("doctorId") int doctor_id,@Param("isAppointmentActive") boolean isAppointmentActive ,@Param("isDoctorActive")boolean isDoctorActive);*/
