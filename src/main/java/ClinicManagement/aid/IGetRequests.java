...
public interface IGetRequests {
    ...
    // ResponseEntity<JSONArray> getMedTimes();
...
//    ResponseEntity<JSONArray> getAppointmentByDate(java.util.Date date);
    ...
    @GetMapping("/attachment/url/id/{id}")
    ResponseEntity<Resource> getAttachmentURL(@PathVariable int id) throws FileNotFoundException, IOException;
