...
public class DoctorService {
    ...
    /*public DoctorService setRepository(DoctorRepository repository) {
        this.repository = repository;
        return this;
    }

    public DoctorService setAppointmentService(AppointmentService appointmentService) {
        this.appointmentService = appointmentService;
        return this;
    }

    public DoctorService setAppointmentRepository(AppointmentRepository appointmentRepository) {
  ...
  /*  public List<Doctor> getDoctorByTime(String time,boolean isDoctorActive) {
        List<Doctor> doctors =  repository.findByWorkDay(time,isDoctorActive);
        if (doctors.isEmpty()) throw new NotFoundException();
        return doctors;
    }*/
